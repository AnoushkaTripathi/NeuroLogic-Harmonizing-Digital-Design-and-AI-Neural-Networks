...
HD_PWD='C:/Users/anous/Desktop/vnpu/lstm/lstm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lstm_cell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lstm_cell.tcl -notrace
